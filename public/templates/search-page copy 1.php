...
if (!empty($query)) {
    ...
    $result = $rag_engine->search($query, $selected_collections);
}
?>
    ...
    <div class="oraculo-container">
        <div class="oraculo-header">
            <h1 class="oraculo-title">
                <?php _e('Oráculo Tainacan', 'oraculo-tainacan'); ?>
            </h1>
            <div class="oraculo-subtitle">
                <?php _e('Faça perguntas sobre o acervo em linguagem natural', 'oraculo-tainacan'); ?>
            </div>
        </div>
            ...
            <form method="get" action="<?php echo esc_url(home_url('oraculo')); ?>">
                <div class="oraculo-search-input-container">
                    <input type="text" 
                           ...
                           placeholder="<?php _e('Faça sua pergunta sobre o acervo...', 'oraculo-tainacan'); ?>"
                           value="<?php echo esc_attr($query); ?>"
                           required>
                    <button type="submit" class="oraculo-search-button">
                        <span class="oraculo-search-icon">&#128269;</span>
                        <span class="oraculo-search-text"><?php _e('Perguntar', 'oraculo-tainacan'); ?></span>
                    </button>
                </div>
                ...
                <?php if (!is_wp_error($collections) && !empty($collections)): ?>
                    <div class="oraculo-collections-filter">
                        ...
                        <div class="oraculo-collections-options">
							...
							<?php
// Certifique-se que $selected_collections é um array
        ...
        <?php else: ?>
            <div class="oraculo-examples">
                <div class="oraculo-examples-heading">
                    <?php _e('Exemplos de perguntas que você pode fazer:', 'oraculo-tainacan'); ?>
                </div>
                
                <div class="oraculo-examples-list">
                    <div class="oraculo-example">
                        <?php _e('Quais são as principais obras de arte do movimento modernista no acervo?', 'oraculo-tainacan'); ?>
                    </div>
                    <div class="oraculo-example">
                        <?php _e('Me explique a história e o contexto de criação das principais peças cerâmicas indígenas.', 'oraculo-tainacan'); ?>
                    </div>
                    <div class="oraculo-example">
                        <?php _e('Quais fotografias do século XIX retratam a vida urbana?', 'oraculo-tainacan'); ?>
                    </div>
                    <div class="oraculo-example">
                        <?php _e('Que artefatos arqueológicos mais antigos estão disponíveis no acervo?', 'oraculo-tainacan'); ?>
                    </div>
                </div>
            </div>
        <?php endif; ?>
